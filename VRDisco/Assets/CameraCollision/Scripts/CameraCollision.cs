...
public class CameraCollision : MonoBehaviour {
	...
	float zoomDistance = 1.0f; //the distance the camera will zoom per scroll
	...
	void Start () {
		...
		maxZoomIn = (int)(Vector3.Distance(transform.position, focusPoint.transform.position) / zoomDistance);
	}
